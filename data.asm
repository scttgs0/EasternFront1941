...
JOYSTICK_TBL    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,1
...
;   Terrain cost table
TERRAIN_TBL     .byte 6,12,8,0,0,18,14,8,20,128
...
YINC            .byte 1
XINC            .byte 0,$FF,0,1
OffenseBonus    .byte 1,1,1,1,1,1,2,2,1,0   ; offensive bonus based on terrain type
...
DefenseBonus    .byte 2,3,3,2,2,2,1,1,2,0   ; defensive bonus based on terrain type
...
DPINITVALS      .word $0000             ; map address
                .byte $00               ; active corp
                .word $02A8             ; cursor x  $310 - player-0-x
                                        ;   =735 - player-0-x - left-border... =735-104-48... =583
                .word $0268             ; cursor y  $2C0 - player-0-y      
                                        ;   =623 - player-0-y - top-border...  =623-88-32...  =503
